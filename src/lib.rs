...
#[derive(Debug)]
pub struct NeoConfigProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoConfigProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoConfig processing");
    
    let mut processor = NeoConfigProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoConfigProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoConfigProcessor::new(false);
